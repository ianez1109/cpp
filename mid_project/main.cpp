...
int main() {
    ...
    Book book4("Davide", "Iannello", "C++ fatto easy", "a88-521-837-E");   // should give invalid isbn
    Book book5("Alberto", "Celadin", "C++ fatto easy", "988-521-837-+");  // should give invalid isbn
